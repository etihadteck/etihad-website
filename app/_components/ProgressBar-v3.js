        ...
        return (
          ...
          >
            <div className="mt-6 flex flex-col items-center justify-center gap-1 text-center text-sm font-semibold">
              <div
                className={`${isCircleFilled ? 'bg-accent-700 text-accent-50' : 'bg-accent-50 text-primary-950'} flex items-center justify-center rounded-full px-10 py-8.5 transition-all duration-500 ease-in-out`}
                style={{
            ...
            {index + 1 < array.length && (
              <div
                className={`${isLineFilled ? 'bg-accent-700' : 'bg-accent-50'} px-18 py-1 transition-all duration-500 ease-in-out`}
                style={{
